...
public class MainActivity extends AppCompatActivity implements  RvInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = databaseReference = FirebaseDatabase.getInstance().getReference("Kcal");
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
              ...
              //neden çalışmıyor bilinmiyor
              int progress = (dailyKcalModel.getKcal()/1250*100);
